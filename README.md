...
Данный проект не является официальным, я не имею никакого отношения к команде разработчиков сервиса Digiseller.
...
Зачем он делался? - Для упрощения вызовов API методов, упрощение взаимодействия.
